...
// AUDIO ASSETS
export const sfxRep = new Audio(
  "https://assets.mixkit.co/sfx/preview/mixkit-mechanical-crate-pick-up-3154.mp3",
);
export const sfxError = new Audio(
  "https://assets.mixkit.co/sfx/preview/mixkit-wrong-answer-fail-notification-946.mp3",
);
export const sfxWin = new Audio(
